    ...
    <div  style=" width:100%; margin:auto">  
        ...
        <form name="form" id="form" class="form" action="#" method="post" >
            ...
            <?php if($verify_type!='view'){ ?>
                <div class="formHeader">Rent Schedule Payment Verification</div>
            <?php }else{ ?>
                    ...
                    <tr> 
                        ...
                        <td>  
                            <?php
                                ...
                                echo $location_type_dr_amount_without_vat;
...
<?php $i = 1;
         foreach ($others_type_data as $others_type_data_row) {  ?>
                ...
                <tr> 
                        ...
                        <td>  
                            <input type="hidden" value="<?php echo $account_no; ?>" name="others_location_type_data_rent_gl<?php echo $i; ?>" >
                            <?php echo $account_no; ?>  
                        </td>
                    ...
                    <tr style="<?=$vat_display?>"> 
                        ...
                        <td>
                         ...
                         <?php 
                            ...
                            $mysqldate = date( 'M Y ', $phpdate );
                            //$narration_1 = "  Rent of  $result_agree_info->location_name for $mysqldate VAT";
...
<?php   
    ...
    foreach ($others_type_data as $others_type_data_row) {  
            ...
            <tr style="<?=$vat_display?>"> 
                        ...
                        <td>
                            <input type="hidden" value="<?php echo $account_no; ?>" name="others_location_vat_rent_gl<?php echo $i; ?>" >
                            <?php echo $account_no; ?>   
                        </td>
                        <td> Rent Office 
...
foreach ($landlords_result as $landlord_row) {
    ?>
                  ...
                  <tr style="<?=$display;?>">  
                        ...
                        <td>   </td>
                        <td> 
                            <input type="hidden" value="<?php echo $rent_gl[0]->gl_account_no; ?>" name="landlord_adv_rent_gl<?php echo $i; ?>" >
...
?>
                <tr style="<?=$vat_display_1?>"> 
                    ...
                    <td>  
                        ...
                        <input type="hidden" value="<?php echo $gl_account; ?>" name="location_vat_rent_gl_cr" >
                        <?php echo $gl_account; ?>
                    </td>
                    <td> <?=$acc_name;?></td>
                    <td> </td> 
                ...
                foreach ($landlords_result as $landlord_row) {
                    ...
                    <tr style="<?=$display;?>"> 
                        ...
                        <td> 
                            ...
                            //$landlord_tax_amount = $landlord_adj_amount * ($tax_percentage->tax_amount / 100);
            ...
            ?>
                        ...
                        <?php 
                            ...
                            if($landlord_row->landlord_payment_mode=='Pay Order'){
                                ...
                                $narration_1 = " PO favouring $landlord_row->name for $mysqldate ";
                            }else{
                        ...
                        ?>
                             ...
                             <input type="hidden" value="<?php echo $landlord_row->name; ?>" name="per_landlord_amt_name_tot_cr<?php echo $i; ?>" >
                        </td>
                    </tr> 
...
<?php
if(count($others_type_data)==0){$others_string = ' and '.$others_type_names->others_loc_names;}
if($single_paid_data->sche_payment_sts=='stop_unpaid_payment' || $single_paid_data->sche_payment_sts=='stop_payment' || $single_paid_data->sche_payment_sts=='stop_payment_pm'){
    
    $narr_str=''; 
        if($others_type_names->others_loc_names==''){
            $narr_str=$others_type_names->loc_names;     
        }else{
                        ...
                        <td>  
                            <?php
                               ...
                               // $monthly_others = $non_prov_paid_data->tot_others_amount ;
                                // $monthly_others = $others_type_data_row->other_cost_in_percent * ($single_paid_data->rent_fraction_day / 100);
                                // $location_type_dr_amount = $monthly_others ;
                                $monthly_rent_with_others_and_arear = $non_prov_paid_data->tot_monthly_rent + $non_prov_paid_data->tot_others_amount + $non_prov_paid_data->tot_area_amount ;
                                $others_location_type_dr_amount = $monthly_rent_with_others_and_arear * ($others_type_data_row->others_type_percentage / 100);
...
<!-- stop receive paid amount to provision gl -->
            ...
            <tr> 
                        ...
                        <td>  
                                ...
                                if($single_paid_data->sche_payment_sts=='stop_payment_pm'){
                                    $accrual_amt = $monthly_rent_with_all_for_stop_cost + $vat_for_accrual_pm;
                                }else{
                        ...
                        <td> 
                            ...
                            $narration_1 = " Rent of $narr_str at $result_agree_info->location_name for $mysqldate";
                                echo $narration_1 ;
                            ?>
...
<?php if($single_paid_data->sche_payment_sts=='stop_payment'){ ?>
        <tr> 
                        <td> 
        ...
        <?php $i++;  } 
                ...
                foreach ($landlords_result as $landlord_row) {
                    ...
                    <tr style="<?=$display;?>"> 
                        ...
                        <td> Tax  <?php //echo $landlord_row->name; ?>
                            <input type="hidden" value="<?php echo $landlord_row->name; ?>" name="landlord_tax_ll_name<?php echo $i; ?>" >
                        </td>
                        <td> </td>  
                        ...
                        <td> 
                            ...
                            $mysqldate = date( 'M Y ', $phpdate );
                            $narration_1 = number_format($tax_rate,2). "  pc Tax from $landlord_row->ll_name from rent of $narr_str at $result_agree_info->location_name for $mysqldate";
            ...
            <!-- Land Lords -->
                    ...
                    <?php if($verify_type!='view'){ ?>
                         <div class="" style="text-align:center;padding-top:40px;">
                            <center><input type="button" value="Verify" id="sendButton" class="buttonStyle" /> <span id="loading" style="display:none">Please wait... <img src="<?= base_url() ?>images/loader.gif" align="bottom"></span> <center>
                                <br />
                        </div>
                    <?php } ?>
