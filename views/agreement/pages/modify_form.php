...
// if (jQuery("#inc_select option:selected").length =='') {
//     jQuery(".incr_per_val").prop('disabled', true);
//   }else{
            ...
            jQuery("#yearly_adj_type").change(function() {
                ...
                if (jQuery('#yearly_adj_type :selected').val() == 'yearly_adj_percent') {
                    ...
                    if (exp != '' && start != '') {
                     ...
                     //jQuery("#type_head").text('Fixed Amount'); 
                     //jQuery(".abc").show(); 
                }
              });
 ...
 var wizard = (function () {
                ...
                return {  
                    ...
                    validate: function (notify) {
                        ...
                        // if (!this.forthTab(notify)) {

                        //    jQuery('#jqxTabs').jqxTabs('disableAt', 4);
                           
                        //     return;
                        // }else {
                        //     jQuery('#jqxTabs').jqxTabs('enableAt', 4);  
                    ...
                    //     if (message !== '') {
                    //         //this.showHint(message, '#hintBasket');
                    //         return false;
                    //     }
        ...
        wizard.init();
 // jQuery('#form2').jqxValidator('hide');

//             jQuery("#cost_center1").on('select', function(event) {
...
// for(count=1;count<=count_location_type;count++){
...
//             });
  ...
  //                // alert(jQuery('#location_type :selected').val()); 
  //               if (jQuery('#location_type :selected').val() == 'branch') {
                  
                 
  //                 //  jQuery("#info").html('<div id="branch_id" name="mis_code1"></div>');
  //                   jQuery("#branch_id").show();
  //                  //jQuery(this).next().next().next("div").attr("id","branch_id");
  //               }
  //               else {
  //                   jQuery('.year_basis').hide();
  //               }
    ...
    //alert((jQuery("#"+field).val()=='')&&(jQuery("#bill_type").val()=='Vendor Advance') ||(jQuery("#bill_type").val()=='Bill With Adjustment') ||(jQuery("#bill_type").val()=='Bill Without Adjustment'))
        ...
        function addmore_location_type() {
            ...
            str +=   '<td style="text-align:center"><input name="square_ft' + count_location_type + '" type="text" class="number flags" id="square_ft' + count_location_type + '" value="" align="left"  style="text-align:left;width:110px;" onblur="cost_sft('+ count_location_type +')"  onkeyup="cal_total_sft('+ count_location_type +')" /></td>' +
                    '<td style="text-align:center"><input name="cost_sft' + count_location_type + '" type="text" class="number flags" id="cost_sft' + count_location_type + '" value="" align="left"  style="text-align:left;width:130px;"   onblur="cost_per_month_blur('+ count_location_type +')"/></td>' +
...
// 30 july 2019
function cost_per_month_blur(count){
    ...
    if(monthly_rent > 0){
        ...
        for(var i=1;i<=count_location_type;i++){
            ...
            {
                cost_per_month= cost_per_month + +jQuery("#cost_sft"+i).val();
            }
        }
        ...
        if(cost_per_month > 0){
            for(var i=1;i<=count_location_type;i++){
                if( jQuery("#delete_landlord_type"+i).val()==0)
                {
                    ...
                    var per_sft_cost = ( total_square_ft * jQuery("#cost_sft"+i).val() )/ monthly_rent ;
                    jQuery("#square_ft"+i).val(per_sft_cost.toFixed(4));
                }
            }
            ...
            for(var i=1;i<=count_others_rent_type;i++){
                if( jQuery("#delete_others"+i).val()==0)
                {
                    ...
                    if(parseFloat(per_amount) > 0){
                         jQuery("#others_square_ft"+i).val(0);
        ...
        if(monthly_rent > 0){
            ...
            if( jQuery("#delete_landlord_type"+count).val()==0)
            {
               jQuery("#cost_sft"+count).val(((jQuery("#location_type_amount_percentage"+count).val() * monthly_rent )/100).toFixed(4));
                jQuery("#square_ft"+count).val(((jQuery("#location_type_amount_percentage"+count).val() * total_square_ft )/100).toFixed(4));
                cal_total_sft(1);
            }
    ...
    function calculate_cost_by_others_percent(count){
        ...
        if(monthly_rent > 0){
                ...
                if( jQuery("#delete_others"+count).val()==0)
                {
                    ...
                    jQuery("#others_square_ft"+count).val(0);
                    cal_total_sft(1);
                }
...
jQuery("#yrly_adj_amt"+i).on("blur",function(){
        ...
        if(yearly_adj_type=="yearly_adj_percent"){
            ...
            jQuery("#cal_month_adj_amt"+i).val(parseFloat(calculated_monthly_adj_per));
             ...
             // if(parseFloat(yrly_adj_percent_amt) > parseFloat(monthly_rent)){
                    ...
                    else if(jQuery("#amount_percentage"+i).val()=='')
                    {
                    ...
                    }else if(jQuery("#advance_amount_percentage"+i).val()=='')
                        {
                            ...
                            if(parseInt(jQuery("#amount_percentage"+i).val())==0 && jQuery("#credit_sts"+i).val()!='No'){
                                alert('Rent Percentage Amount is Zero at row '+i);
                                return false;
                            }else{
                        ...
                        <table class="register-table"  width="60% !important;">
                           <input name="agreement_id_edit" type="hidden" id="agreement_id_edit" value="<?php echo isset($agreement->id) ? $agreement->id : NULL; ?>"  class="text-input-small" />
                            ...
                            <tr>
                                ...
                                <td>  <? if($add_edit=='modify'){ echo $agreement->agreement_ref_no;} else { echo ' Auto Generated'; }?> </td>
<!--                                <td><input type="text"  name="agreement_ref_no" id="agreement_ref_no" class="text-input-small" value="<?php echo isset($agreement->agreement_ref_no) ? $agreement->agreement_ref_no : ''; ?>" /></td>-->
                    ...
                    <?php if($this->session->userdata['user']['user_department_id']==4 || $this->session->userdata['user']['user_id']==1){ ?>
                            <tr>
                                ...
                                <td><? if($add_edit=='modify'){ echo $agreement->fin_ref_no;} else { echo ' Auto Generated'; }?></td>
                            </tr>
                    <?php } ?>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="rent_start_dt" id="rent_start_dt" class="text-input-small"   value="<?php echo isset($agreement->rent_start_dt) ? date('d/m/Y', strtotime($agreement->rent_start_dt)) : ''; ?>" readonly/></td>
                            </tr> 

                            <tr>
                                <td>Agreement Expired Date<span style="color:#FF0000">*</span></td>
                                <td>
                                    <input type="text"  name="agree_exp_dt" id="agree_exp_dt"  class="text-input-small" value="<?php echo isset($agreement->agree_exp_dt) ? date('d/m/Y', strtotime($agreement->agree_exp_dt)) : ''; ?>" readonly/>
                                ...
                                <tbody>
                                    ...
                                    <tr id="tr_landlord_type<?=$i?>" style="border-top: 1px solid black !important; text-align:center;">
                                     ...
                                     <!--    <td id="info" width="15%"> </td> -->
                                        ...
                                        <td width="15%"><input name="cost_sft<?=$i?>" type="text" class="name flags number" id="cost_sft<?=$i?>" value="<?php echo $row->cost_per_month; ?>"  style="width:130px"   onblur="cost_per_month_blur(1)" /></td>
                                ...
                                if(count($others_rent_location_result) > 0){
                                    ...
                                    <tr id="others_rent_tr<?=$i?>" style="border-top: 1px solid black !important; text-align:center;">
                                     ...
                                     <!--    <td id="info" width="15%"> </td> -->
                                        ...
                                        <td width="15%"><input name="others_cost_sft<?=$i?>" type="text" class="name flags number " id="others_cost_sft<?=$i?>" value="<?php echo $row->other_cost_in_percent; ?>"  style="width:120px"  readonly/></td>
 ...
 -->                                        <option <?php echo (isset($agreement->adjust_adv_type) && ($agreement->adjust_adv_type == "3" && $rent_adjustment_result[0]->percent_dir_type == "percent_total_amt")) ? 'selected="selected"' : ''; ?> value="percent_total_amt">% of total advance amount (For entire agreement period)</option>
              ...
              <?php 
                        ...
                        <div id="basketButtonsWrapper">
                            ...
                            <input type="button" value="Next" class="nextButton" id="nextButtonBasket" onClick="increment_ajax_onclick_nxt()"/>
                        </div>
                ...
                <form class="form" id="form4" method="post" action="#" >
                    ...
                    <table class="register-table"  width="60% !important;">
                            ...
                            <tr id="one_time_increment_tr">
                                ...
                                <td>
                                    <input name="one_time_increment_yr_no" class="number" id="one_time_increment_yr_no" value="<?php echo (isset($agreement->increment_type) && $agreement->increment_type == "3") ? $agreement->increment_type_val : ''; ?>"  class="text-input-small" type="text" /> Year
                                </td>
                            </tr> 
                            ...
                            <tr id="every_yr_increment_tr">
                                ...
                                <td>
                                    <input name="increment_every_yr_value" class="number" id="increment_every_yr_value" value="<?php echo (isset($agreement->increment_type) && $agreement->increment_type == "2") ? $agreement->increment_type_val : ''; ?>"  class="text-input-small" /> Year
                                </td>
                            </tr>
                            ...
                            <tr id="increment_start_tr">
                                ...
                                <td>
                                    <input name="increment_start_dt_value" id="increment_start_dt_value" value="<?php echo isset($agreement->incr_start_date) ? date('d/m/Y', strtotime($agreement->incr_start_date)) : ''; ?>"  class="text-input-small" />
                                </td>
                            </tr>
